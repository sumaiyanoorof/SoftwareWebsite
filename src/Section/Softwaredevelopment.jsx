...
const Softwaredevelopment = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1604783125462-37d81c7385e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB0ZWNobm9sb2d5JTIwb2ZmaWNlfGVufDF8fHx8MTc2MDA0NTIxOXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      icon: Cloud,
  ...
  return (
     <div className="relative overflow-hidden bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-0 left-1/4 w-96 h-96 bg-red-900/20 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            x: [0, 50, 0],
            y: [0, 30, 0],
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        >
          <motion.div variants={itemVariants} className="mb-6">
            <motion.div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-800/20 border border-red-900/30 mb-8"
              whileHover={{ scale: 1.05 }}
            >
              <Sparkles className="w-4 h-4 text-red-700" />
              <span className="text-sm text-gray-300">Premium Software Solutions</span>
            </motion.div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-gray-600/50 backdrop-blur-sm border border-red-800/20 rounded-xl p-6 group hover:border-red-700/50 transition-all duration-300"
              >
                <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {process.map((step, index) => (
              ...
              >
                <motion.div
                  className="bg-gray-500/50 backdrop-blur-sm border border-red-800/20 rounded-xl p-6 h-full hover:border-red-700/50 transition-all duration-300"
                  whileHover={{ y: -10 }}
                >
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <motion.div
          className="max-w-4xl mx-auto text-center bg-gradient-to-r from-red-800 to-red-700 rounded-3xl p-12 relative overflow-hidden"
        ...
        >
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link to="/contact">
              <Button className="bg-white text-red-800 hover:bg-gray-100 px-8 py-6 text-lg group">
