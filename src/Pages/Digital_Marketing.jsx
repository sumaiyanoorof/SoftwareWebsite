...
return (
    <div id="digital-marketing" className="relative overflow-hidden bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      <SEO
        title="Digital Marketing | LoginXol"
        description="Digital marketing strategies from LoginXol to drive traffic, leads, and conversions with SEO, social media, and paid campaigns."
        canonical="https://loginxol.com/digital-marketing"
        keywords="digital marketing, SEO, PPC, social media, email marketing, LoginXol"
      />
