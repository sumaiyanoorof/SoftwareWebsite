...
const Contact = () => {
  ...
  return (
    ...
    >
      <SEO
        title="Contact LoginXol | Start Your Project"
        description="Contact LoginXol to discuss your digital project, website, software, IT consulting, or marketing strategy."
        canonical="https://loginxol.com/contact"
        keywords="contact LoginXol, digital agency contact, request a quote, project consultation"
      />
