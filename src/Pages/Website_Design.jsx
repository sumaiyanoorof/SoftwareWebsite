...
const Website_Design = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
      <SEO
        title="Website Design | LoginXol"
        description="LoginXol creates responsive website designs focused on conversions, branding, and fast mobile experiences."
        canonical="https://loginxol.com/website-design"
        keywords="website design, responsive design, UX UI, conversion optimization, LoginXol"
      />
