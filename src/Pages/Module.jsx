  ...
  return (
   <motion.section 
    ...
    variants={fadeInVariants}
     >
      <SEO
        title="LoginXol | Modules & Solutions"
        description="Explore LoginXol's scalable digital modules and product solutions for efficient business growth."
        canonical="https://loginxol.com/modules"
        keywords="LoginXol, digital modules, product solutions, business systems, software modules"
      />
